...
namespace Grocery.App.ViewModels
{
    ...
    public partial class GroceryListItemsViewModel : BaseViewModel
    {
        ...
        private void GetAvailableProducts()
        {
            ...
            //Haal de lijst met beschikbare producten op
            List<Product> availableProducts = _productService.GetAvailableProducts(GroceryList.Id);
            
            //Voeg de beschikbare producten toe aan de ObservableCollection
